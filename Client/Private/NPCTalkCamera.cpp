...
void CNPCTalkCamera::Priority_Update(_float fTimeDelta)
{
    m_pTransformCom->Set_State(STATE::POSITION
        , m_pTargetTransform->Get_State(STATE::POSITION) + m_pTargetTransform->Get_State(STATE::LOOK) * 1.4f + m_pTargetTransform->Get_State(STATE::RIGHT) * 0.1f + XMVectorSet(0.f, 1.35f, 0.f, 0.f));
