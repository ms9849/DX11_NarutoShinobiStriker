...
{
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::LOGO), TEXT("Prototype_Component_Texture_Button"),
...
_bool CTestButton::IsClicked()
{
	if (PtInRect(&m_rcButton, m_pGameInstance->Get_MousePos()) && m_pGameInstance->Key_Down(VK_LBUTTON))
		return true;
