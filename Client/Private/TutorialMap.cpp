...
HRESULT CTutorialMap::Ready_Components()
{
	...
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::GAMEPLAY), TEXT("Prototype_Component_Model_TutorialMap"),
...
CTutorialMap* CTutorialMap::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, OBJECTID eObjectID)
{
