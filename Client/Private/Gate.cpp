...
CGate::CGate(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, OBJECTID eObjectID)
...
CGate* CGate::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, OBJECTID eObjectID)
{
