...
#pragma endregion
	...
	/* 인스턴스 버퍼를 생성한다. */
	/* 1. 인스턴스들의 위치는 어디인지 (행렬) */
	/* 2. LiftTime은 얼마인지, */
	/* 3. 인스턴스는 몇개인지 */
	/* 4. 인스턴스 하나당 인덱스는 몇개인지 */
	/* 등을 저장한다. 하지만 원한다면 색깔 등의 여러 조건도 세팅할 수 있다고 함.*/
	/*
	셰이더 단에서 세팅해줄 필요가 있다면 버퍼에, 
	코드 단에서 세팅해야 한다면 멤버 변수에 선언한다고 하심.
	*/
