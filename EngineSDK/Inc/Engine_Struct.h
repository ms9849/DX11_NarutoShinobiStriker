...
namespace Engine
{
	...
	typedef struct tagVertexPosInstanceParticleDesc
	{
		...
		static constexpr D3D11_INPUT_ELEMENT_DESC		Elements[] = {
			...
			{ "TEXCOORD", 0, DXGI_FORMAT_R32G32B32_FLOAT, 1, 64, D3D11_INPUT_PER_INSTANCE_DATA, 1 }, // rotation
			{ "TEXCOORD", 1, DXGI_FORMAT_R32G32_FLOAT,	  1, 76, D3D11_INPUT_PER_INSTANCE_DATA, 1 }, // lifetime
			{ "TEXCOORD", 2, DXGI_FORMAT_R32G32_FLOAT,	  1, 84, D3D11_INPUT_PER_INSTANCE_DATA, 1 }, // DeltaAcc
			{ "TEXCOORD", 3, DXGI_FORMAT_R32G32B32_FLOAT, 1, 92, D3D11_INPUT_PER_INSTANCE_DATA, 1 }, // Direction
		};
